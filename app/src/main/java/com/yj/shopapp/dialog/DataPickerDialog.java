...
public class DataPickerDialog {
    ...
    public DataPickerDialog(Context context, TimePickerDialogInterface timePickerDialogInterface) {
        super();
        mContext = context;
    ...
    private View initDatePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(
                R.layout.data_picker_layout, null);
    ...
    private View initDateAndTimePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(
                R.layout.dataandtime_picker, null);
        mDatePicker = (DatePicker) inflate.findViewById(R.id.dateAndTimePicker_timePicker);
        mTimePicker = (TimePicker) inflate.findViewById(R.id.dateAndTimePicker_datePicker);
        mTimePicker.setIs24HourView(true);
        resizePikcer(mTimePicker);
        resizePikcer(mDatePicker);
        return inflate;
