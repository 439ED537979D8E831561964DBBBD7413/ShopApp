...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, CommonUtils.dip2px(getContext(),0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = CommonUtils.dip2px(getContext(), DEF_DRAW_SIZE);
