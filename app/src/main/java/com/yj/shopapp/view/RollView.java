 ...
 */
public class RollView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RollView, defStyleAttr, 0);
        mTextColor = a.getColor(R.styleable.RollView_textcolor, Color.RED);
        mTextSize = a.getDimension(R.styleable.RollView_textSizes, 48);
        mIsRepeat=a.getBoolean(R.styleable.RollView_isRepeat,false);
        mStartPoint=a.getInt(R.styleable.RollView_startPoint,0);
        mDirection=a.getInt(R.styleable.RollView_direction,0);
        mSpeed=a.getInt(R.styleable.RollView_speed,20);
        a.recycle();
