...
public class CashCouponListAdapter implements IRecyclerViewIntermediary {
    ...
    public CashCouponListAdapter(Context context, List<CashCoupon> noteList, CardListRecyclerView myItemClickListener, List<Integer> chooseArray) {
    ...
    public RecyclerView.ViewHolder getViewHolder(ViewGroup viewGroup, int type) {
        ...
        return new CashCouponListAdapter.HomeFragmentViewHolder(v);
    }
    ...
    public void populateViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        final CashCouponListAdapter.HomeFragmentViewHolder holder = (CashCouponListAdapter.HomeFragmentViewHolder) viewHolder;
        final CashCoupon  cashCoupon = notes.get(position);
        // final double prise=Double.parseDouble(cartList.getPrice());
        holder.clent_tv.setText(cashCoupon.getUsername());
