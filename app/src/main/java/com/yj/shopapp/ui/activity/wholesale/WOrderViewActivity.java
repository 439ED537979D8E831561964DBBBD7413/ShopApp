 ...
 */
public class WOrderViewActivity extends BaseFragment implements BaseRecyclerView {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        WOrderAdapter oAdapter = new WOrderAdapter(mActivity, orderList, this);
...
//        showToastShort("点击"+position);
        ...
        CommonUtils.goActivity(mActivity, SOrderDetailActivity.class, bundle, false);
    }
