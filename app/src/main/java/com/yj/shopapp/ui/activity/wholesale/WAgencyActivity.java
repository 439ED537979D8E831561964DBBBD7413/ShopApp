 ...
 */
public class WAgencyActivity extends BaseActivity implements BaseRecyclerView {
    ...
    List<Agency> agentsList = new ArrayList<>();
   // List<SortModel> sortModels = new ArrayList<>();
    ...
    protected void initData() {
        ...
        AgencyAdapter sAdapter = new AgencyAdapter(WAgencyActivity.this, agentsList, this);
