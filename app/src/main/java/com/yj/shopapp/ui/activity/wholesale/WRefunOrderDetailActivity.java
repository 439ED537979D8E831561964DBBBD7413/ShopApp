...
//        idRightBtu.setText("筛选");
        ...
        SOrderDetailAdapter oAdapter = new SOrderDetailAdapter(mContext, notes, 0, this);
        ...
        iLoadView = new ILoadViewImpl(mContext, new WRefunOrderDetailActivity.mLoadMoreClickListener());

        loadMoreView = iLoadView.inflate();

        recyclerView.addOnScrollListener(new WRefunOrderDetailActivity.MyScrollListener());
    ...
    public void refreshRequest() {
        ...
        HttpHelper.getInstance().post(mContext, Contants.PortA.Refundsorderdetails, params, new OkHttpResponseHandler<String>(mContext) {
