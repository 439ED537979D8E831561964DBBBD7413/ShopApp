...
public class WCashCouponActivity extends BaseActivity implements CardListRecyclerView {
    ...
    public void delCart() {
        ...
        int i = 0;
        for (CashCoupon cartList : megsList) {
    ...
    protected void initData() {
        ...
        CashCouponListAdapter nAdapter = new CashCouponListAdapter(WCashCouponActivity.this, megsList, this, chooseArray);

        layoutManager = new LinearLayoutManager(mContext);

        adapter = new RecyclerViewHeaderFooterAdapter(layoutManager, nAdapter);

        iLoadView = new ILoadViewImpl(mContext, new WCashCouponActivity.mLoadMoreClickListener());

        loadMoreView = iLoadView.inflate();

        recyclerView.addOnScrollListener(new WCashCouponActivity.MyScrollListener());
    ...
    public void refreshRequest() {
        ...
        HttpHelper.getInstance().post(mContext, Contants.PortA.Cash, params, new OkHttpResponseHandler<String>(mContext) {
